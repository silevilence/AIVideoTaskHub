...
- [ ] **[P1] 新增Provider AIHubMix**
    ...
    - [ ] 规范复用
        - [ ] 提取不同视频接口的规范，做成可复用的工具形式
    - [ ] 文档地址：`https://docs.aihubmix.com/cn/api/Video-Gen`，实现前参考一下
    - [ ] 支持参数
        - **待补充**
    - [ ] 模型列表
